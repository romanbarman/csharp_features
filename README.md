...
1.  [Auto property initializers](https://github.com/romanbarman/csharp_features/blob/main/CSharp.Features.6.0/AutoPropertyInitializers.cs)
2.  [```await``` in ```catch/finally``` block](https://github.com/romanbarman/csharp_features/blob/main/CSharp.Features.6.0/AwaitInCatchFinallyBlock.cs)
3.  [Dictionary initializers](https://github.com/romanbarman/csharp_features/blob/main/CSharp.Features.6.0/DictionaryInitializers.cs)
4.  [Exception filtering](https://github.com/romanbarman/csharp_features/blob/main/CSharp.Features.6.0/ExceptionFiltering.cs)
5.  [Expression bodied function property](https://github.com/romanbarman/csharp_features/blob/main/CSharp.Features.6.0/ExpressionBodiedFunctionProperty.cs)
6.  [```nameof``` expression](https://github.com/romanbarman/csharp_features/blob/main/CSharp.Features.6.0/NameofExpression.cs)
7.  [Null conditional operator](https://github.com/romanbarman/csharp_features/blob/main/CSharp.Features.6.0/NullConditionalOperator.cs)
